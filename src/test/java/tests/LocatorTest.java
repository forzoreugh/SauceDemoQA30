...
public class LocatorTest extends BaseTest {
    ...
    public void checkLocator() {
        ...
        driver.findElement(By.xpath("//div[contains(@data-test,'inventory')]" + "//ancestor::a[@id='item_1_title_link']"));
        driver.findElement(By.xpath("//a[@id='item_1_title_link']" + "//descendant::div[@data-test='inventory-item-name']"));
        driver.findElement(By.xpath("//a[@id='item_1_title_link']" + "//following::div[@class='inventory_item_desc']"));
        driver.findElement(By.xpath("//a[@id='item_1_title_link']" + "/parent::div"));
        driver.findElement(By.xpath("//a[@id='item_1_title_link']" + "/preceding::div"));
        driver.findElement(By.xpath("//a[@id='item_1_title_link' " + "and @data-test='item-1-title-link']"));
